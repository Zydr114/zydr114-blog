...
export const siteConfig: SiteConfig = {
	title: "Zydr's Blog",
	subtitle: "One day...",
	siteURL: "https://blog.talium.site/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-05", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Zydr114",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/2005058760",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://twikoo.talium.site",
		lang: SITE_LANG,
	},
};
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://music.talium.site/api?server=:server&type=:type&id=:id&r=:r", // Meting API 地址
	id: "14111895974", // 歌单ID
...
export const footerConfig: FooterConfig = {
	...
	customHtml: "<a href=\"https://beian.miit.gov.cn/\" target=\"_blank\">渝ICP备2026003897号</a>", // HTML格式的自定义页脚信息，例如备案号等，默认留空
